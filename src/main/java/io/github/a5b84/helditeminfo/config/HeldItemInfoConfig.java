...
public class HeldItemInfoConfig {
  ...
  public TextBackgroundVisiblity tooltipBackgroundVisibility() {
    return TextBackgroundVisiblity.VANILLA;
  }
  ...
  public static class HeldItemInfoAutoConfig extends HeldItemInfoConfig implements ConfigData {
    ...
    @Tooltip(count = 2)
    private boolean preventOverlap = super.preventOverlap();

    @Tooltip(count = 2)
    @ConfigEntry.Gui.EnumHandler(option = ConfigEntry.Gui.EnumHandler.EnumDisplayOption.BUTTON)
    private TextBackgroundVisiblity tooltipBackgroundVisibility =
        super.tooltipBackgroundVisibility();

    @PrefixText private boolean showName = super.showName();
    ...
    @Override
    public float offsetPerExtraLine() {
      return offsetPerExtraLine;
    }

    @Override
    public int itemNameSpacing() {
      return itemNameSpacing;
    }
    ...
    @Override
    public float fadeDurationPerExtraLine() {
      return fadeDurationPerExtraLine;
    }
    ...
    @Override
    public TextBackgroundVisiblity tooltipBackgroundVisibility() {
      return tooltipBackgroundVisibility;
    }
    ...
    @Override
    public boolean showContainerContent() {
      return showContainerContent;
    }

    @Override
    public boolean mergeSimilarContainerItems() {
      return mergeSimilarContainerItems;
    }

    @Override
    public boolean showFireworkAttributes() {
      return showFireworkAttributes;
    }

    @Override
    public boolean showCommandBlockInfo() {
      return showCommandBlockInfo;
    }

    @Override
    public int maxCommandLines() {
      return maxCommandLines;
    }

    @Override
    public boolean showBeehiveContent() {
      return showBeehiveContent;
    }

    @Override
    public boolean showSpawnerEntity() {
      return showSpawnerEntity;
    }

    @Override
    public boolean showCrossbowProjectiles() {
      return showCrossbowProjectiles;
    }
    ...
    @Override
    public boolean showMusicDiscDescription() {
      return showMusicDiscDescription;
    }

    @Override
    public boolean showPaintingDescription() {
      return showPaintingDescription;
    }

    @Override
    public boolean showGoatHornInstrument() {
      return showGoatHornInstrument;
    }
    ...
    @Override
    public boolean showFilledMapId() {
      return showFilledMapId;
    }

    @Override
    public boolean showEntityBucketContent() {
      return showEntityBucketContent;
    }
    ...
    @Override
    public boolean showHiddenLinesCount() {
      return showHiddenLinesCount;
    }

    @Override
    public boolean showOnlyFilteredEnchantments() {
      return showOnlyFilteredEnchantments;
    }
